...
class Seat extends Component {
  ...
  componentDidMount(){
    axios.get('https://red-bus-nodejs.herokuapp.com/api/getseats')
    .then(res => {
      console.log(res);
  ...
  axios.get('https://red-bus-nodejs.herokuapp.com/api/close')
  .then(res => {
    ...
    try{
      ...
      for(var i=0;i<s.length;i++)
      {
        if(!cs.includes(s[i]))
        {
          ...
          console.log(user);
          var res=axios.post('https://red-bus-nodejs.herokuapp.com/api/booking',user, {
                headers: {
           ...
           <div style={
            {
              ...
              <hr></hr>
              <center><h2 style={{fontFamily:"Lucida Handwriting", textShadow:"2px 2px 5px #e6e600"}}>Book your Seats Now!</h2></center>
